//
// This version will attempt to add a fret number to the node, and use that fret number upon creation.
//
...
MDNode_v2 {
	...
	*new {|name = "an MDNode (v2)"|
	...
	// now changed to
		this.children = Array.fill(24, {nil}) // on initialisation, this node contains 24 slots which are ordered from 0 to n-1
	}
	...
	attachAt {|fretno, branchToAdd|
		this.children.put(fretno,branchToAdd);
	}
